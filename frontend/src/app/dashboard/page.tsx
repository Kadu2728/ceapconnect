 ...
 * "O que preciso fazer?", "Quanto falta?", "Qual minha próxima etapa?").
 * Client Component: depende do guard de sessão (Zustand) e de uma query
 * autenticada (`GET /api/v1/dashboard`).
 */
